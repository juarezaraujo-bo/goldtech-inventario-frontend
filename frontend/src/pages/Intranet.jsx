...
import { isAdminRole, isGoldtechTeamRole } from '../utils/roles';
...
export default function Intranet() {
  ...
  const canAccessDocumentation = isGoldtechTeamRole(currentUser.role);
  ...
  useEffect(() => {
    if (canAccessDocumentation) fetchDocuments();
  ...
  if (!canAccessDocumentation) {
    return (
      <div className="animate-fade-in">
        <div className="page-header">
          <div>
            <h1>Intranet GoldTech</h1>
            <p>Documentação interna protegida.</p>
          </div>
        </div>
        <div className="glass-panel" style={{ padding: '2rem', display: 'flex', gap: '1rem', alignItems: 'center' }}>
          ...
          <div>
            ...
            <p style={{ margin: '0.35rem 0 0', color: 'var(--text-muted)' }}>Somente o time GoldTech pode acessar a documentacao interna.</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="animate-fade-in">
      <div className="page-header">
        <div>
          <h1>Intranet GoldTech</h1>
          <p>Documentação técnica interna por cliente.</p>
        </div>
